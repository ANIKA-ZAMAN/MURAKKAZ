    ...
    return (
      <header className="w-full px-6 py-4 flex justify-center items-center sticky top-3 z-50 bg-transparent" suppressHydrationWarning>
        <nav className="relative w-full max-w-[1348px] h-16 overflow-hidden select-none flex items-center justify-between px-6 bg-transparent" suppressHydrationWarning>
          ...
          {/* Overlay active/hovered icon SVGs to color them red dynamically */}
          <svg 
            viewBox="0 0 1348 64" 
          ...
          <Link 
            href="/wishlist" 
            suppressHydrationWarning
            className="absolute right-[103px] top-1/2 -translate-y-1/2 w-6 h-6 z-20 cursor-pointer rounded-full" 
            aria-label="Wishlist"
          ...
          <Link 
            href="/cart" 
            suppressHydrationWarning
            className="absolute right-[64px] top-1/2 -translate-y-1/2 w-6 h-6 z-20 cursor-pointer rounded-full" 
            aria-label="Cart"
          ...
          <Link 
            href="/account"
            aria-label="Account"
            className="absolute right-[25px] top-1/2 -translate-y-1/2 w-6 h-6 z-20 cursor-pointer border-none bg-transparent outline-none rounded-full"
            suppressHydrationWarning
