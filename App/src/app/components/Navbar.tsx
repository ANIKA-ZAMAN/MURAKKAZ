      ...
      <header className="w-full px-6 py-4 flex justify-center items-center sticky top-3 z-50 bg-transparent" suppressHydrationWarning>
        <nav className="relative w-full max-w-[1348px] h-16 overflow-hidden select-none flex items-center justify-between px-6 bg-transparent" suppressHydrationWarning>
          ...
          <div className="flex items-center z-10 flex-shrink-0" suppressHydrationWarning>
            <form onSubmit={handleSearchSubmit} className="w-[160px] xl:w-[180px] h-9 relative mr-2" suppressHydrationWarning>
              <input
                ...
                className={`absolute left-[15%] top-0 w-[80%] h-full border-none outline-none font-serif-text text-[13px] text-neutral-800 transition-colors ${
          ...
          <Link 
            href="/wishlist" 
            suppressHydrationWarning
            className="absolute right-[103px] top-1/2 -translate-y-1/2 w-6 h-6 z-20 cursor-pointer rounded-full flex items-center justify-center" 
            aria-label="Wishlist"
          ...
          <Link 
            href="/cart" 
            suppressHydrationWarning
            className="absolute right-[64px] top-1/2 -translate-y-1/2 w-6 h-6 z-20 cursor-pointer rounded-full flex items-center justify-center" 
            aria-label="Cart"
          ...
          >
            ...
            >
              <path 
                d="M1276.67 28V26.0333C1276.67 25.4205 1276.55 24.8136 1276.31 24.2474C1276.08 23.6813 1275.73 23.1668 1275.3 22.7335C1274.87 22.3001 1274.35 21.9564 1273.79 21.7219C1273.22 21.4873 1272.61 21.3666 1272 21.3666C1271.39 21.3666 1270.78 21.4873 1270.21 21.7219C1269.65 21.9564 1269.13 22.3001 1268.7 22.7335C1268.27 23.1668 1267.92 23.6813 1267.69 24.2474C1267.45 24.8136 1267.33 25.4205 1267.33 26.0333V30.7C1267.33 30.8768 1267.4 31.0463 1267.53 31.1714C1267.65 31.2964 1267.82 31.3666 1268 31.3666C1268.18 31.3666 1268.35 31.2964 1268.47 31.1714C1268.6 31.0463 1268.67 30.7V29.3333H1274V28H1268.67V26.0333C1268.67 25.1492 1269.02 24.3014 1269.64 23.6763C1270.27 23.0512 1271.12 22.7 1272 22.7C1272.88 22.7 1273.73 23.0512 1274.36 23.6763C1274.98 24.3014 1275.33 25.1492 1275.33 26.0333V30.6666C1275.33 30.8434 1275.4 31.013 1275.53 31.138C1275.65 31.2631 1275.82 31.3333 1276 31.3333C1276.18 31.3333 1276.35 31.2631 1276.47 31.138C1276.6 31.013 1276.67 30.6666 1276.67 30.6666V29.3333H1280V41.3333H1264V29.3333H1266V28H1262.67V41.3933C1262.67 41.731 1262.8 42.0549 1263.04 42.2937C1263.28 42.5325 1263.6 42.6666 1263.94 42.6666H1280.06C1280.4 42.6666 1280.72 42.5325 1280.96 42.2937C1281.2 42.0549 1281.33 41.731 1281.33 41.3933V28H1276.67Z" 
          ...
          <Link 
            href="/account"
            aria-label="Account"
            className="absolute right-[25px] top-1/2 -translate-y-1/2 w-6 h-6 z-20 cursor-pointer border-none bg-transparent outline-none rounded-full flex items-center justify-center"
            suppressHydrationWarning
