                ...
                loginMethod === "email" ? (
                  ...
                  <form onSubmit={handleLogin} className={styles.form}>
                    ...
                    <div className={styles.socialGroup}>
                      <button type="button" onClick={handleGoogleLogin} className={styles.btnSocial}>
                        <svg viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "8px" }}>
                      ...
                      <button type="button" onClick={() => setLoginMethod("phone")} className={styles.btnSocial}>
                        <svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "8px" }}>
                  ...
                  <form onSubmit={handlePhoneSubmit} className={styles.form}>
                    {!otpSent ? (
                      ...
                      <>
                        <p style={{ fontSize: "0.8rem", color: "#767677", marginBottom: "0.25rem" }}>
                ...
                <form onSubmit={handleRegister} className={styles.form}>
                  ...
                  <div className={styles.socialGroup}>
                    ...
                    <button type="button" className={styles.btnSocial}>
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "10px" }}>
