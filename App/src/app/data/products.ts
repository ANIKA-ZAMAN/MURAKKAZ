...
export const luxuryProducts: Product[] = [
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/sultani_v6.jpg",
    "family": "ORIENTAL",
    "gender": "MEN",
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/ehsas_v3.jpg",
    "family": "ORIENTAL",
    "gender": "MEN",
    "occasion": "Daily & Executive",
    "meter": "BEAST_MODE",
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/acqua_di_gio_elixir_v3.jpg",
    "family": "AQUATIC",
    "gender": "MEN",
    "occasion": "Daily & Executive",
    "meter": "BEAST_MODE",
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/japanese_cherry_blossom_v3.jpg",
    "family": "FLORAL",
    "gender": "WOMEN",
    "occasion": "Romantic & Daytime",
    "meter": "LONG_LASTING",
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/dior_homme_parfum_v3.jpg",
    "family": "WOODY",
    "gender": "MEN",
    "occasion": "Daily & Executive",
    "meter": "BEAST_MODE",
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/millesime_imperial_v3.jpg",
    "family": "AQUATIC",
    "gender": "UNISEX",
    "occasion": "Versatile",
    "meter": "LONG_LASTING",
      ...
      if (Array.isArray(items) && items.length > 0) {
        cachedProducts = items.map((p: any) => {
          ...
          if (itemSlug === "resala" || (p.name && p.name.toLowerCase().includes("resala"))) {
            itemImage = "/images/products/resala_v3.jpg";
          }
          return {
            id: p.id || itemSlug,
            slug: itemSlug,
