...
export const luxuryProducts: Product[] = [
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/miss_dior_blooming_bouquet.jpg",
    "family": "FLORAL",
    "gender": "WOMEN",
    "occasion": "Romantic & Daytime",
    "meter": "LONG_LASTING",
      ...
      if (Array.isArray(items) && items.length > 0) {
        cachedProducts = items.map((p: any) => {
          ...
          return {
            ...
            image: (p.image && p.image.includes("irish_leather")) ? "/images/products/irish_leather_v2.jpg" : (p.image && p.image.includes("tobacco_vanille")) ? "/images/products/tobacco_vanille_v4.jpg" : (p.image && (p.image.includes("baccarat_rouge") || p.image.includes("baccarat"))) ? "/images/products/baccarat_rouge_540_v2.jpg" : (p.image && p.image.includes("by_the_fireplace")) ? "/images/products/by_the_fireplace_v2.jpg" : (p.image && p.image.includes("aventus") && !p.image.includes("absolu")) ? "/images/products/aventus_v2.jpg" : (p.image && p.image.includes("angels_share")) ? "/images/products/angels_share_v2.jpg" : (p.image && p.image.includes("chance_eau_tendre")) ? "/images/products/chance_eau_tendre_v2.jpg" : (p.image || "/images/products/baccarat_rouge_540_v2.jpg"),
