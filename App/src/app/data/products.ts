...
export const luxuryProducts: Product[] = [
  ...
  },
  {
    ...
    "originalPriceVal": 400,
    "volume": "6ml - 50ml",
    "image": "/images/products/tobacco_vanille_v3.jpg",
    "family": "GOURMAND",
    "gender": "UNISEX",
      ...
      if (Array.isArray(items) && items.length > 0) {
        cachedProducts = items.map((p: any) => {
          ...
          return {
            ...
            image: (p.image && p.image.includes("irish_leather")) ? "/images/products/irish_leather_v2.jpg" : (p.image && p.image.includes("tobacco_vanille")) ? "/images/products/tobacco_vanille_v3.jpg" : (p.image || "/images/products/baccarat_rouge.jpg"),
