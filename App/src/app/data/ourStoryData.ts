export const ourStoryData = {
  creator: {
    headingLine1: "The Creator:",
    headingLine2: "Eliyash Hossain",
    paragraph:
    ...
    imageAlt: "Eliyash Hossain crafting artisanal fragrances with fragrance lovers at campus event",
  },
  ...
  journeySections: [
    {
      ...
      bottomNode: "02",
      isHeading: true,
      headingLine1: "Journey For The Love Of",
      headingLine2: "Fragrance",
    },
    {
      id: "journey-story-1",
      topNode: "01",
  ...
  gallery: {
    ...
    paragraph:
      "Luxury is personal, and I love meeting our community face-to-face. From elite fashion exhibitions to exclusive perfumer meetups across Bangladesh, we bring the sensory experience directly to you. See our current store locations, live bottle-painting workshops, and past interactions.",
